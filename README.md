...
- 숫자가 올라가는 애니메이션 효과 직접 만들어보기<br />
  숫자가 올라가는 애니메이션 요구 사항을 useFadeIn과 같이 hooks로 만들어보려고 하다 카운트가 올라가는 컴포넌트를 따로 만들어 보는 것도 재밌겠다는 생각을 기점으로 컴포넌트로 만들어보게 되었습니다. 이번 과제를 통해 조금 더 다방면으로 커스텀 훅을 만들어보고 여러 프로젝트에 적용해보고 싶다는 생각을 하게 되었습니다.

- 재사용성이 있는, 공용 컴포넌트 만들기<br />
